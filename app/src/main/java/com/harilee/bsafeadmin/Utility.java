...
public class Utility {
    ...
    public void setPreference(Context context, String key, String value) {
        ...
        SharedPreferences.Editor editor = context.getSharedPreferences("bsafe admin", Context.MODE_PRIVATE).edit();
    ...
    public String getPreference(Context context, String key) {
        ...
        SharedPreferences prefs = context.getSharedPreferences("bsafe admin", Context.MODE_PRIVATE);
